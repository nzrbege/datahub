...
<div class="pdp-notice">
    ...
    <div><strong>Permohonan Dikembalikan:</strong> Perbaiki alasan dan tujuan penggunaan, lalu lampirkan ulang dokumen permohonan. Setelah dikirim, status permintaan kembali ke verifikasi Super Admin.</div>
</div>
...
<div style="display:grid; grid-template-columns:3fr 2fr; gap:20px; align-items:start;">
        ...
        <div class="card-body">
            <form action="{{ route('admin.requests.update', $dataRequest) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="info-grid" style="margin-bottom:18px;">
                    ...
                    <div class="info-row">
                        <div class="info-label">Dokumen Sebelumnya</div>
                ...
                <div class="form-group">
                    <label class="form-label">Dokumen Permohonan Baru <span class="required">*</span></label>
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap; margin-bottom:8px;">
                        <div class="form-text" style="margin-top:0;">Gunakan template terbaru jika perlu memperbaiki format surat.</div>
                    ...
                    <div style="display:flex; align-items:center; gap:10px;">
                        <div id="ndaDropZone" style="flex:1; border:1.5px dashed var(--border-dark); border-radius:var(--radius-sm); padding:14px 16px; cursor:pointer; display:flex; align-items:center; gap:10px; transition:all .15s; background:var(--surface-2);"
                            ...
                            <div>
                                ...
                                <div style="font-size:11px; color:var(--text-muted);">Wajib unggah ulang dokumen permohonan PDF &bull; Maks 5MB</div>
                            </div>
                        </div>
                        <input type="file" name="request_file" id="ndaInput" accept=".pdf" style="display:none;" required onchange="showNda(this)">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alasan_permintaan" class="form-control" rows="5" required>{{ old('alasan_permintaan', $dataRequest->reason_and_purpose) }}</textarea>
    ...
    <div class="card">
        ...
        <div class="card-body" style="font-size:13px; line-height:1.7; color:var(--text-2);">
            ...
            <p style="margin-top:10px;">Super Admin akan melihat isian dan dokumen permohonan terbaru untuk review ulang.</p>
        </div>
    </div>
</div>
